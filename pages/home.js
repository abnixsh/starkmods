...
function HomePage() {
  ...
  // Inject styles once
  if (!document.getElementById('stark-hero-v3')) {
  ...
  <div class="max-w-6xl mx-auto pb-24 animate-fade-in relative px-3 sm:px-6 pt-6">
    ...
    <section class="mb-4 text-center py-10 px-4 isolate relative">
       ...
       <div class="relative z-10 flex flex-col items-center">
          ...
          <!-- Tagline -->
          <p class="stark-in text-sm sm:text-lg text-slate-600 dark:text-slate-300 mb-8 max-w-xl mx-auto leading-relaxed font-medium mt-4" style="animation-delay: 0.2s">
            Premium, Secure & Anti-Ban Mod Menus for iOS & Android.
          </p>
          
          <!-- Buttons -->
          <div class="stark-in flex flex-wrap justify-center gap-4 w-full" style="animation-delay: 0.3s">
