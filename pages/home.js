    ...
    <div class="app-card-screenshots mb-4 rounded-lg overflow-hidden bg-black screenshot-carousel">
      <div class="screenshot-carousel-track h-full flex transition-transform duration-300">
        <div class="screenshot-carousel-slide min-w-full h-full">
          <img src="assets/img/img_rc20_1.jpg" class="w-full h-full object-cover opacity-90" alt="RC20 screenshot 1">
        </div>
        <div class="screenshot-carousel-slide min-w-full h-full">
          <img src="assets/img/img_rc20_2.jpg" class="w-full h-full object-cover opacity-90" alt="RC20 screenshot 2">
        </div>
        <div class="screenshot-carousel-slide min-w-full h-full">
          <img src="assets/img/img_rc20_3.jpg" class="w-full h-full object-cover opacity-90" alt="RC20 screenshot 3">
        </div>
        <div class="screenshot-carousel-slide min-w-full h-full">
          <img src="assets/img/img_rc20_4.jpg" class="w-full h-full object-cover opacity-90" alt="RC20 screenshot 4">
        </div>
      </div>
