...
function Wcc3Page() {
    ...
    <div class="max-w-4xl mx-auto animate-fade-in">
      ...
      <div class="flex items-center gap-4 mb-8">
         <img src="assets/icons/icon_wcc3.png" class="w-20 h-20 rounded-2xl shadow-lg" alt="WCC3 Logo">
         <div>
         ...
         <div class="screenshot-carousel rounded-xl overflow-hidden shadow-lg aspect-video relative">
              <div class="screenshot-carousel-track h-full flex transition-transform duration-500">
                <div class="screenshot-carousel-slide min-w-full h-full">
                  <img src="assets/img/img_wcc3_1.jpg" class="w-full h-full object-cover" loading="lazy" alt="Screenshot 1" />
                </div>
                <div class="screenshot-carousel-slide min-w-full h-full">
      ...
      <div class="grid md:grid-cols-2 gap-6">
          ...
          <div class="app-card p-6 rounded-2xl">
            <h3 class="text-xl font-bold mb-4">Vip Mod Features</h3>
            <ul class="space-y-3 text-slate-600 dark:text-slate-300">
               ...
               <li class="flex items-start gap-3"><span class="material-icons text-green-500 mt-1">check_circle</span><span>Unlock All Jerseys</span></li>
               <li class="flex items-start gap-3"><span class="material-icons text-green-500 mt-1">check_circle</span><span>Unlock All Commentary</span></li>
		   <li class="flex items-start gap-3"><span class="material-icons text-green-500 mt-1">check_circle</span><span>Unlock All Stadiums</span></li>
		   <li class="flex items-start gap-3"><span class="material-icons text-green-500 mt-1">check_circle</span><span>Unlock All Stadiums</span></li>
		   <li class="flex items-start gap-3"><span class="material-icons text-green-500 mt-1">check_circle</span><span>Advance Customisation Unlock</span></li>
            </ul>
          </div>
