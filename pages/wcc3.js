function Wcc3Page() {
    ...
    <div class="max-w-4xl mx-auto animate-fade-in pb-20">
      ...
      <div class="flex items-center gap-4 mb-8">
         <img src="assets/icons/icon_wcc3.png" class="w-20 h-20 rounded-2xl shadow-lg" onerror="this.src='https://placehold.co/80?text=RC20'">
         <div>
             <h1 class="text-3xl font-bold">WCC3 vip Mod Menu</h1>
             <div class="flex gap-2 mt-2">
                ...
                <span class="px-2 py-0.5 bg-black-100 dark:bg-red-900 text-gold dark:text-blue-300 text-xs font-bold rounded">VIP</span>
             </div>
         </div>
      </div>
