    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="app-card p-6 rounded-2xl mb-8 bg-slate-900 text-white">
        <div class="flex flex-col md:flex-row items-center gap-6">
           <img src="assets/icons/icon_rc20.jpg" class="w-24 h-24 rounded-2xl shadow-lg" alt="RC20 Logo">
           <div class="flex-1 text-center md:text-left">
             <h2 class="text-2xl font-bold">RC20 Ultimate</h2>
             <div class="text-slate-400 mb-3">com.stark.rc20</div>
             <div class="flex flex-wrap justify-center md:justify-start gap-2 mb-4">
               <span class="px-3 py-1 rounded-full bg-slate-800 border border-slate-700 text-xs">Version 2.5</span>
