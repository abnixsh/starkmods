    ...
    <div class="max-w-4xl mx-auto animate-fade-in pb-20">
      ...
      <div class="flex items-center gap-4 mb-8">
         ...
         <div>
             ...
             <div class="flex gap-2 mt-2">
                ...
                <span class="px-2 py-0.5 bg-blue-100 dark:bg-red-900 text-white dark:text-blue-300 text-xs font-bold rounded">Anti-ban</span>
             </div>
         </div>
      </div>
         ...
         <div class="screenshot-carousel rounded-xl overflow-hidden shadow-lg aspect-video relative group">
              <div class="screenshot-carousel-track h-full flex transition-transform duration-300">
                <div class="screenshot-carousel-slide min-w-full h-full">
                  <img src="assets/img/img_rc25_1.jpg" class="w-full h-full object-cover" loading="lazy" alt="Screenshot 1" />
                </div>
                <div class="screenshot-carousel-slide min-w-full h-full">
                  <img src="assets/img/img_rc25_2.jpg" class="w-full h-full object-cover" loading="lazy" alt="Screenshot 2" />
                </div>
              </div>
      ...
      <div class="grid md:grid-cols-2 gap-6">
          ...
          <div class="app-card p-6 rounded-2xl flex flex-col justify-between">
            ...
            <div class="space-y-3">
                <button onclick="window.addToCart('rc25', '1month')" class="w-full py-3 px-4 border border-blue-600 text-blue-600 dark:text-blue-400 rounded-xl font-bold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition flex items-center justify-between">
                    <span>1 Month Access</span>
                    <span>₹250</span>
                </button>

                <button onclick="window.addToCart('rc25', 'lifetime')" class="w-full py-3 px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-bold shadow-lg transition transform hover:-translate-y-1 flex items-center justify-between">
