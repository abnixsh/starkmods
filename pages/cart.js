    ...
    <div class="max-w-3xl mx-auto animate-fade-in">
      ...
      <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 mb-8 shadow-sm">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-4">
            <!-- Game icon instead of material icon -->
            <div class="bg-blue-50 dark:bg-slate-900 p-3 rounded-xl flex items-center justify-center w-14 h-14">
              <img src="${item.image}"
                   alt="${item.gameName}"
                   class="w-10 h-10 rounded-lg object-cover"
                   onerror="this.src='https://placehold.co/40x40?text=MOD'">
            </div>
            <div>
      ...
      <div class="flex justify-between items-center p-6 bg-slate-50 dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700">
        ...
        <button onclick="window.router.navigateTo('/checkout')"
                class="bg-green-600 hover:bg-green-700 text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-green-600/20 transition transform hover:-translate-y-1 flex items-center gap-2">
